...
this to speed up our Mandelbrot program. At this point, that should
look something like this:
...
If it doesn't, no worries. There is a hidden version of the program
that looks exactly like this in your "mandel" directory and you can
copy it to your current mandel program like this:
